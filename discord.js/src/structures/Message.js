...
class Message {
  ...
  setup(data) { // eslint-disable-line complexity
     ...
     * @type {?Message}
     */
    this.referencedMessage = data.referenced_message ? this.client.actions.MessageCreate.handle(data.referenced_message).message : null
  ...
  async reply(content, options) {
    ...
    if (!options.disableNotificationReminder) {
      const userData = await functions.checkForDatabaseData(this.author.id)

      const logs = userData.currency_logs

      if (logs.length > 0) {
        const logs2 = logs.filter(e => e.read === false)
    ...
    if (!options.disableWhitespaceRemoval) {
      content = content.replace(/^ +/gm, "")
    }

    if (options.websiteEmbed) {
      if (content) {
        const oldContent = content
        content = `${oldContent}||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||||​||${options.websiteEmbed}`
      } else {
        content = options.websiteEmbed
      }
    }

    if (!options.disableAutoQuote) {
      content = content.split("\n").map(content => `> ${content}`).join("\n")
    }
    ...
    Object.assign(options, {
      ...
      allowed_mentions: {
        replied_user: options.allowedMentions ? options.allowedMentions.repliedUser : false
      }
    })
  ...
  tryResolving(resolve, thingToResolve) {
    resolve(thingToResolve)
  }
