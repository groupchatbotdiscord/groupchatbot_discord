...
declare module 'discord.js' {
	...
	export class Client extends EventEmitter {
		...
		public addToWallet(id: Snowflake, amountToAdd: Number): void;
		public removeFromWallet(id: Snowflake, amountToRemove: Number): void;
		public getTotalMoney(id: Snowflake): Number;
		public clearInterval(interval: NodeJS.Timer): void;
		public clearTimeout(timeout: NodeJS.Timer): void;
		public destroy(): Promise<void>;
		public fetchUser(id: Snowflake, cache?: boolean, force?: boolean): Promise<User>;
	...
	export class Guild {
		...
		public createChannel(name: string, options?: ChannelData): Promise<CategoryChannel | TextChannel>;
		public createChannel(name: string, type?: GuildChannelType, reason?: string): Promise<CategoryChannel | TextChannel>;
	...
	class GuildAuditLogsEntry {
		...
		public target: Guild | User | Role | Emoji | null;
	...
	export class StreamDispatcher extends VolumeInterface {
		constructor(player: any, stream: NodeJS.ReadableStream, streamOptions: StreamOptions);
	...
	export class Util {
		...
		public static cleanContent(text: string, client: Client): String
	}
	...
	type GuildChannelType = 'category' | 'text' | 'news' | 'store';
	...
	type MessageOptions = {
		...
		disableNotificationReminder?: boolean;
		disableNewLineAfterNotifications?: boolean;
		disableAutoQuote?: boolean;
		disableWhitespaceRemoval?: boolean;
		autoQuote?: boolean;
	};
